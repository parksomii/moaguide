...
public interface ReportRepository extends JpaRepository<Report, Long> {
	...
	Page<ReportCustomDto> findBydetail(@Param("category") String category,
	...
	// 리포트 상세
	@Query(
		"SELECT new com.moaguide.dto.NewDto.customDto.ReportCustomDto(r.id, r.title, r.content, r.category, r.date) "
			+
	...
	Page<ReportCustomDto> findAllByViews(@Param("subcategory") String subcategory,
		Pageable pageable);
	...
	Page<ReportCustomDto> findListByAllbyViews(@Param("category") String category,
		@Param("subcategory") String subcategory, Pageable pageable);
	...
	Page<ReportCustomDto> findAllbyLatest(@Param("subcategory") String subcategory,
		Pageable pageable);
	...
	Page<ReportCustomDto> findListByAllbyLatest(@Param("category") String category,
		@Param("subcategory") String subcategory, Pageable pageable);
}
