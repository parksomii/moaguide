...
public interface ArticleRepository extends JpaRepository<Article, Long> {
    ...
    @Query("SELECT new com.moaguide.dto.NewDto.customDto.ArticleDto(a.id,a.title,a.description,a.imageLink,a.date,a.link) FROM article a where a.category is null and a.id<:nextCursor order by a.id desc")
