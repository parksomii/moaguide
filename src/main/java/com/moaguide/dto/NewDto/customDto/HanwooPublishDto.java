...
public class HanwooPublishDto {
    ...
    // 매개변수 있는 생성자
    public HanwooPublishDto(String name, String type, int piece, int basePrice, String totalPrice, String recruitingType,
                            String rightsStructure, String revenueStructure, LocalDate paymentDate, LocalDate subscriptionDate,
