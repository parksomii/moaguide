...
public interface RentRepository extends JpaRepository<Rent, Integer> {
	...
	@Query("SELECT new com.moaguide.refactor.building.dto.RentDto(r.year,r.quarter,r.region,r.rent) FROM Rent r,BuildingDetail bd where r.keyword = bd.keyword  AND r.type = :type AND bd.productId.productId = :productId AND r.year between :syear and :eyear order by r.region,r.year,r.quarter")
	...
	@Query("SELECT distinct new com.moaguide.refactor.building.dto.TypeDto( r.type) FROM BuildingDetail bd,Rent r where bd.keyword = r.keyword and bd.productId.productId=:productId")
