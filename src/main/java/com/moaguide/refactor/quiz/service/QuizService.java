package com.moaguide.refactor.quiz.service;
...
public class QuizService {
	...
	@Async
	public void insertUserRank(String nickname, LocalTime time, String naver, String insta,
		int score, long id, int size) {
	...
	public void insertUserAnswer(String nickname, List<Integer> answer, long quizId, String type,
		List<Long> faillist, List<Integer> failanswer) {
