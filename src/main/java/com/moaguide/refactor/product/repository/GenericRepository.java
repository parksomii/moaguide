...
public class GenericRepository {
	...
	public List<SummaryCustomDto> findlistBookmark(int page, int size, String sort,
		String nickname) {
		return entityManager.createNativeQuery("CALL list_bookmark(:page, :size, :sort, :nickname)",
				"SummaryCustomDtoMapping")
	...
	public List<SummaryCustomDto> findCustomList(int page, int size, String sort, String nickname) {
		return entityManager.createNativeQuery("CALL list(:page, :size, :sort,:nickname)",
				"SummaryCustomDtoMapping")
			.setParameter("page", page)
			.setParameter("size", size)
			.setParameter("sort", sort)
	...
	public List<SummaryCustomDto> findCustomListCategory(int page, int size, String sort,
		String category, String nickname) {
		// 프로시저를 호출하는 네이티브 쿼리
		return entityManager.createNativeQuery(
				"CALL list_category(:page, :size, :sort, :category,:nickname)",
				"SummaryCustomDtoMapping")
			.setParameter("page", page)
			.setParameter("size", size)
			.setParameter("sort", sort)
	...
	public List<IssueCustomDto> findCustomIssue(int page, int size, Date sqlDate, String nickname) {
		// 프로시저를 호출하는 네이티브 쿼리
		return entityManager.createNativeQuery("CALL Issue(:page, :size, :day,:nickname)",
				"IssueCustomDtoMapping")
			.setParameter("page", page)
			.setParameter("size", size)
	...
	public List<IssueCustomDto> findCustomStart(int page, int size, Date sqlDate, String nickname) {
		return entityManager.createNativeQuery("CALL start(:page, :size, :day,:nickname)",
				"IssueCustomDtoMapping")
			.setParameter("page", page)
			.setParameter("size", size)
			.setParameter("day", sqlDate)
	...
	public List<IssueCustomDto> findCustomIssueCategory(int page, int size, Date sqlDate,
		String category, String nickname) {
		return entityManager.createNativeQuery(
				"CALL Issue_category(:page, :size, :day, :category,:nickname)", "IssueCustomDtoMapping")
			.setParameter("page", page)
			.setParameter("size", size)
			.setParameter("day", sqlDate)
			.setParameter("category", category)
	...
	public List<IssueCustomDto> findCustomStartCategory(int page, int size, Date sqlDate,
		String category, String nickname) {
		return entityManager.createNativeQuery(
				"CALL start_category(:page, :size, :day, :category,:nickname)", "IssueCustomDtoMapping")
			.setParameter("page", page)
			.setParameter("size", size)
			.setParameter("day", sqlDate)
			.setParameter("category", category)
	...
	public List<IssueCustomDto> findCustomIssuebyBookmark(int page, int size, Date sqlDate,
		String nickname) {
		return entityManager.createNativeQuery("CALL Issue_bookmark(:page, :size, :day, :nickname)",
				"IssueCustomDtoMapping")
			.setParameter("page", page)
			.setParameter("size", size)
			.setParameter("day", sqlDate)
	...
	public List<IssueCustomDto> findCustomStartBookmark(int page, int size, Date sqlDate,
		String nickname) {
		return entityManager.createNativeQuery("CALL start_bookmark(:page, :size, :day, :nickname)",
				"IssueCustomDtoMapping")
			.setParameter("page", page)
			.setParameter("size", size)
			.setParameter("day", sqlDate)
	...
	public List<SummaryCustomDto> funble(int page, int size, String sort, String nickname) {
		// 프로시저를 호출하는 네이티브 쿼리
		return entityManager.createNativeQuery("CALL funble(:page, :size, :sort,:nickname)",
				"SummaryCustomDtoMapping")
			.setParameter("page", page)
			.setParameter("size", size)
			.setParameter("sort", sort)
