...
public class MovieInfoDto {
	...
	public MovieInfoDto(String movieInfo, String subgenre, Date releaseDate, String grade,
		Integer screeningTime, String director, String actor, String distributor,
		String originalInfo) {
